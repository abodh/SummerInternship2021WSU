function [groupss, isolated, disconnected_load] = case_info(mpc, fd)
...
% edited by abodh to get disconnected load
if isempty(p.islands)
    disconnected_load = 0    
else
    disconnected_load = sum([p.d(2:end).Pd]);
end
